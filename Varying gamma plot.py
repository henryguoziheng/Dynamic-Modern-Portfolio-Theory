...
gammaList = np.arange(0.1, 2.1, 0.1)
MeanVar_Dynamic = []
MeanVar_Sbs = []
...
plt.scatter(gammaList, MeanVar_Dynamic, label='dynamic')
plt.scatter(gammaList, MeanVar_Sbs, label='step by step')
plt.title('Dynamic Vs Step by step Optimization varying gamma')
plt.xlabel('Gamma')
plt.ylabel('MeanVar at T=2')
plt.legend(['dynamic', 'step by step'])
plt.savefig('Dynamic Vs Step by step Optimization varying gamma')
plt.show()